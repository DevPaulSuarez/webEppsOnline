				...
				array(
					...
					'fields'      => array(
						...
						array(
							...
							'type' => 'checkbox',
							'std'  => 1,
							'name' => esc_html__( 'Show hierarchy', 'woodmart' ),
						),
						array(
							'id'   => 'hide_empty',
							'type' => 'checkbox',
...
//			}
			...
			if ( ! empty( $categories ) ) {
				switch ( $settings['display'] ) {
					case 'list':
						$this->render_list_view( $args, $settings );
						break;
					case 'dropdown':
						$this->render_dropdown_view( $args, $settings );
						break;
				}
			}
		 ...
		 * @return void
		 */
		public function render_list_view( $args, $settings ) {
		 ...
		 * @return void
		 */
		public function render_dropdown_view( $args, $settings ) {
			global $wp;
		...
		public function get_chosen_categories() {
			...
			return isset( $query_args['filter_category'] ) ? explode( ',', $query_args['filter_category'] ) : array();
		}
